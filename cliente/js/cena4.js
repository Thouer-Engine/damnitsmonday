 ...
 this.load.image("cut3", "../assets/cutfindbeto.png")
  ...
  create() {
    ...
    if (this.game.jogadores.primeiro === this.game.socket.id) {
      this.local = "plinio";
      this.remoto = "beto";
      /* plinio */ this.eu = this.physics.add.sprite(341, 5680, this.local);
      /* beto */ this.ele = this.add.sprite(384, 5699, this.remoto);
    } else if (this.game.jogadores.segundo === this.game.socket.id) {
      this.local = "beto";
      this.remoto = "plinio";
      /* plinio */ this.ele = this.add.sprite(341, 5680, this.remoto);
      /* beto */ this.eu = this.physics.add.sprite(384, 5699, this.local);
